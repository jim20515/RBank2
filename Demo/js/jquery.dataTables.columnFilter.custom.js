...
// else push the value onto the result data array
        ...
        function fnCreateColumnSelect(oTable, aData, iColumn, nTh, sLabel, bRegex, oSelected, bMultiselect) {
            ...
            var r = '<select class="search_init select_filter form-control selectpicker" rel="' + i + '"><option value="" class="search_init">' + sLabel + '</option>';
            if (bMultiselect) {
                r = '<select class="search_init select_filter form-control selectpicker" rel="' + i + '" multiple>';
            }
            var j = 0;
...
//                    oTable.fnFilter(unescape(currentFilter), iColumn);
        ...
        function fnCreateCheckbox(oTable, aData) {
            ...
            var divRowDef = '<div class="checkbox-inline">';
            var divClose = '</div>';
            ...
            for (j = 0; j < iLen; j++) {
                ...
                //check button
                r += '<label><input class="search_init checkbox_filter btn btn-default" type="checkbox" id= "' + uniqueId + '_cb_' + sValue + '" name= "' + localLabel + '" ' + (checked ? ' checked = "checked"' : '') + ' value="' + sValue + '" >' + sLabel + '</label>';
